...
AUTHORITY_CONTACTS = {
    ...
    "Water": {
    "dept": "GHMC – Engineering & Drainage Wing",
    "email": "engineering-ghmc@telangana.gov.in",
    "phone": "040-21111111",
    },
    "Cycling / Walking": {
...
def apply_global_style():
    st.markdown(
        ...
        <style>
        /* ---------------------------------
           1. Remove default Streamlit header
        --------------------------------- */
        ...
        section[data-testid="stSidebar"] {
            ...
            background-color: #e1f5dd !important;
